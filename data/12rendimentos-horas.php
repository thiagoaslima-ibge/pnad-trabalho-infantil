	...
	<!-- Conteudo da pagina [inicio] -->
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">			
			...
			<ul class="bulleted-list">
				<li><strong>Rendimento do assalariado</strong></li>
			...
			<ul class="bulleted-list">
				<li><strong>Rendimento do empregador e do trabalhador por conta própria</strong></li>
					<ul class="bulleted-list bulleted-list--sublist">
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
			...
			<dl class="definition-list">
				...
				<dd>Para a criança de 5 a 13 anos que recebia pagamento somente em benefícios, que não eram pagos em dinheiro, tais como moradia, roupas, alimentação, educação ou creche, que não eram pagos em dinheiro. Esta opção deverá ser marcada apenas quando for a única forma de remuneração mensal pelo trabalho.</dd>
