<?php
	...
	// Titulo do topico
	$topicTitle = "Questionário";
	// Titulo da pagina	
	$pageTitle = "Exercício 8";
...
<main class="page-content okgo">
	...
	<header class="page-header col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
		...
		?>
				<p>Sobre os afazeres domésticos, marque a alternativa <strong>incorreta</strong>, de acordo com os quesitos e conceitos da <span class="small-caps">PNAD</span> Contínua:</p>
