...
<main class="page-content okgo">
	...
	<div class="row">
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
			...
			<p>No questionário sobre trabalho das pessoas de 14 anos ou mais de idade, conforme vimos nos conhecimentos básicos da pesquisa, inicialmente busca-se identificar se o morador deve ser considerado como ocupado ou não na semana de referência. A partir daí é que são exibidas as perguntas que visam qualificar o trabalho. No questionário sobre os moradores de 5 a 13 anos de idade não é diferente. Identificada a existência de trabalho, serão coletadas as seguintes informações:</p>
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
			...
			<ul class="bulleted-list">
				...
				<li>não possuir um estabelecimento para funcionar e o período de espera por clientes ou fregueses for inferior a 30 dias.</li>
			</ul>
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
			...
			<p>Este quesito é destinado somente às crianças de 5 a 13 anos para as quais a resposta foi <strong>Não</strong> no quesito anterior. Observe que a pesquisa vai, aos poucos, investigando, tanto o trabalho tradicionalmente remunerado em dinheiro, quanto o remunerado em produtos, mercadorias, moradia, alimentação, aprendizado etc.</p>
