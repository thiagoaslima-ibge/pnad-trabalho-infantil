...
<main class="page-content okgo">
	...
	<header class="page-header col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
		...
		?>
		<p class="lead">No mundo atual, o desenvolvimento contínuo de distintas formas de atuação do Instituto Brasileiro de Geografia e Estatística (<span class="small-caps">IBGE</span>) deve passar por modificações independentemente das condições financeiras e administrativas exigidas.</p>
	</header>
	...
	<!-- Conteudo da pagina [inicio] -->
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-20 col-sm-offset-2 col-md-16 col-md-offset-4 col-lg-12 col-lg-offset-6 chart">
			<article class="chart-box">
				...
				<footer class="chart-box__notes">
					...
					<p>Fonte: Pesquisa anual de gráficos de linhas, crônicas, sparklines e similares. Instituto Brasileiro de Geografia e Estatística (<span class="small-caps">IBGE</span>), <span class="old-style-figures">2020</span></p>
				</footer>
			</article>
		</div>
...
<span>});</code></pre>
			...
			<p class="video-link">Vídeo <a href="https://youtu.be/Xo7CgqhyhLc" target="_blank" rel="noopener">IBGE lança agência de notícias</a></p>
		...
		<figure class="img-container">
			...
			<figcaption class="col-xs-22 col-xs-offset-1 col-sm-4 col-sm-offset-0 col-md-3 col-lg-2 img-container__caption">
				<div class="img-container__top-line"></div>
				Imagem tamanho M: Mobilidade dos capitais internacionais exige a precisão.
				<small class="img-container__img-src">Fonte: Google.</small>
				<small class="img-container__img-src">Passe o cursor ou toque na imagem para ver mais detalhes.</small>
			</figcaption>
		</figure>
		...
		<figure class="img-container">
			<div class="col-xs-22 col-xs-offset-1 col-sm-17 col-sm-offset-2 col-md-13 col-md-offset-4 col-lg-10 col-lg-offset-6 gutter-sm-right">
				<source srcset="dist/img/mapa--lg.jpg" media="(min-width:1200px)">
				<source srcset="dist/img/mapa--md.jpg" media="(min-width:600px)">
				<source srcset="dist/img/mapa--sm.jpg" media="(min-width:1px)">
				<img class="image" src="dist/img/mapa--lg.jpg" alt="Descrição da imagem.">
			</div>
			<figcaption class="col-xs-22 col-xs-offset-1 col-sm-3 col-sm-offset-0 col-md-3 col-lg-2 img-container__caption">
				<div class="img-container__top-line"></div>
				Imagem tamanho G: O que temos que ter sempre em mente é que a mobilidade dos capitais internacionais exige a precisão. <small class="img-container__img-src">Fonte: <a href="https://portaldemapas.ibge.gov.br/portal.php#mapa1021" target="_blank" rel="noopener">Portal de Mapas <span class="small-caps">IBGE</span></a>.</small>
			</figcaption>
		</figure>
		<!-- Imagem grande [fim] -->
			...
			<li class="col-xs-24 col-sm-12 col-md-8">
				<figure class="photo-mosaic__img-container">
					...
					<figcaption class="photo-mosaic__img-caption">
						<img src="dist/img/g1__Marca-White.svg" alt="Marca do portal G1" class="news__image">	
						<h4 class="news__title"><a href="https://g1.globo.com/economia/noticia/2021/12/28/desemprego-cai-para-121percent-em-outubro-aponta-ibge.ghtml" target="_blank" rel="noopener">Desemprego cai para 12,1% em outubro, mas ainda atinge 12,9 milhões, aponta IBGE</a></h4>
						<p>Por Darlan Alvarenga, 10/01/2022</p>
					</figcaption>
				</figure>
			</li>
			<li class="col-xs-24 col-sm-12 col-md-8">
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
			...
			<section class="news col-xs-24 col-md-22 col-lg-20">
				<img src="dist/img/g1__Marca-Black.svg" alt="Marca do portal G1" class="news__image">
				<h4 class="news__title">Desemprego cai para 12,1% em outubro, mas ainda atinge 12,9 milhões, aponta IBGE</h4>
				<p>Rendimento médio encolhe 11,1% em 1 ano, para R$ 2.449 – o menor valor já registrado na série histórica iniciada em 2012. Número de trabalhadores por conta própria atinge novo recorde.</p>
				<p>Por Darlan Alvarenga, 10/01/2022</p>
			</section>
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-20 col-sm-offset-2 col-md-16 col-md-offset-4 col-lg-12 col-lg-offset-6" style="margin-top:1rem;">
			<ul class="illustrated-list">
				<li class="row">
					<figure>
						<picture class="col-xs-24 col-sm-6 gutter-xs-right">
							<source srcset="dist/img/example-img001--lg.jpg" media="(min-width:1200px)">
							<source srcset="dist/img/example-img001--md.jpg" media="(min-width:600px)">
							<source srcset="dist/img/example-img001--sm.jpg" media="(min-width:1px)">
							<img class="image" src="dist/img/example-img001--lg.jpg" alt="Descrição da imagem.">
						</picture>
						<figcaption class="col-xs-24 col-sm-18">
