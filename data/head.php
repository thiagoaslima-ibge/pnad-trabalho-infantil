<?php
  ...
  $hasThemeCookie = isset($_COOKIE['theme']);
  $themeClass = '';
  if ($hasThemeCookie && $_COOKIE['theme'] === 'dark') {
    $themeClass = "dark-mode";
  }
?>

<!DOCTYPE html>
<!--[if lt IE 7]>      <html lang="pt-br" dir="ltr" class="no-js curso-estatistica lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
<!--[if IE 7]>         <html lang="pt-br" dir="ltr" class="no-js curso-estatistica lt-ie9 lt-ie8"> <![endif]-->
<!--[if IE 8]>         <html lang="pt-br" dir="ltr" class="no-js curso-estatistica lt-ie9"> <![endif]-->
<!--[if gt IE 8]><!--> <html lang="pt-br" dir="ltr" class="no-js curso-estatistica"> <!--<![endif]-->
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">		
  <title>PNAD Contínua | Módulo Trabalho de pessoas de 5 a 13 anos de idade</title>
...
<body class="<?php echo $themeClass ?>" onload="iniciaNavegacao()" onunload="encerraNavegacao()" onbeforeunload="encerraNavegacao()">
  <!--[if lt IE 7]>
  ...
  <header class="main-header">
    <ul class="functions">
      <li class="functions__group">
        <label class="switch">
          <input type="checkbox" class="btn__dark-mode" <?php echo $themeClass == 'dark-mode' ? 'checked' : '' ?>>
        ...
        <?php
          if (!$hasThemeCookie) {
            ...
            var theme = window.localStorage.getItem("theme");
            if (theme === "dark") {
              const inputEl = document.querySelector(".btn__dark-mode");
    ...
    <h1 class="main-header__heading-1" title="Nome do curso">Módulo Trabalho de pessoas de 5 a 13 anos de idade</h1>
      <?php
